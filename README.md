...
**Archive Size**: Large (**https://www.dropbox.com/s/mcdcqxpggsrgyhg/EddiePM.zip**)

**Screenshots**:

![](https://i.imgur.com/BqvrPKY.png)
![](https://i.imgur.com/GeWbUlQ.png)
![](https://i.imgur.com/llJ32Ar.png)

# How install this?

Need Outlast: **https://store.steampowered.com/app/238320/Outlast**

1. Download model: **https://www.dropbox.com/s/mcdcqxpggsrgyhg/EddiePM.zip**
...
7. Download this model and extract "EddiePM" folder in **[Outlast Dir]**/PlayerModels

8. Type in Level_Launcher.bat command line: ``mount [Model Folder Name]`` \
   Example: ``mount EddiePM``
   
9. Start Outlast.

# How update this?

Update model: **https://www.dropbox.com/s/mcdcqxpggsrgyhg/EddiePM.zip**
